...
//## Source file: C:\develop\WinSmartController\mididriver\hal_mac\macmidiinputdriver.cpp
...
MidiInputDriver* MidiInputDriver::create (int queue_size, MidiInputSync* driver)
{
  ...
  return new MacMidiInputDriver (queue_size, driver);
...
void MacMidiInputDriver::DataReady (IOData data)
{
